...
// 2) az group create --name ticketify-rgrp --location centralindia
// 3) az deployment group create --resource-group ticketify-rgrp --template-file main_dev.bicep
// it will prompt for 
/*
Please provide string value for 'webAppName' (? for help): ticketify1-app
Please provide securestring value for 'sqlAdminPassword' (? for help): 
Please provide string value for 'appInsightsName' (? for help): ticketify1-appinsights
*/
...
/*
//For validation ---------------------------------------------------
// az deployment group validate --resource-group ticketify-rgrp --template-file main_dev.bicep --parameters webAppName=ticketify1-app sqlAdminPassword='{yourpassword}'

//and Deploy 

az deployment group create \
  --resource-group ticketify-rgrp \
  --template-file main_dev.bicep \
  --parameters webAppName=ticketify1-app \
               appInsightsName=ticketify-appinsight1 \
